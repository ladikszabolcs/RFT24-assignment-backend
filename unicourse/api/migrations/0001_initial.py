    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('students', models.ManyToManyField(blank=True, limit_choices_to={'role': 'student'}, related_name='lectures', to='api.user')),
                ('teacher', models.ForeignKey(limit_choices_to={'role': 'teacher'}, on_delete=django.db.models.deletion.CASCADE, to='api.user')),
            ],
        ),
    ]
